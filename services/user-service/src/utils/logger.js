...
const logger = winston.createLogger({
  ...
  defaultMeta: { service: 'user-service', env: env.nodeEnv },
  transports: [new winston.transports.Console()],
});

// Redact known-sensitive keys defensively if ever passed as meta.
const SENSITIVE_KEYS = ['password', 'passwordHash', 'password_hash', 'jwtSecret', 'token', 'authorization'];
